...
def save_response(save, schema, job_description, resume, response):
  if save:
    response_data = {
      "messages": [
        {"role": "system", "content": "You are an expert recruiter for a staffing company that specializes in engineering solutions and IT project management services to Fortune 500 companies in the Life Science and Technology industries. Your job is to evaluate and rank how well a candidate's resume matches a job description based on the provided job description and candidate's resume, in JSON. Unless the candidate meets or exceeds every requirement in the job description, give them a score less than 5. Do not recommend candidates that have things like gaps in work history, short tenures, and other similar issues."},
